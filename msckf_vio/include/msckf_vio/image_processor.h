...
private:
  ...
  cv_bridge::CvImageConstPtr cam0_color_img_ptr;
  ...
  message_filters::Synchronizer<message_filters::sync_policies::ApproximateTime<sensor_msgs::Image, sensor_msgs::Image>> stereo_sub;
  // message_filters::Synchronizer<MySyncPolicy> stereo_sub(MySyncPolicy(10), cam0_img_sub, cam1_img_sub);

  // message_filters::Subscriber<sensor_msgs::Image> stereo_sub;
